...
<cfparam name="URL.userid"  default="full">
...
<html>
  <head>
    ...
    <title>Google Maps API Panoramio layer with Google Earth</title>
    <script src="http://www.google.com/jsapi?key=ABQIAAAAPT9xbOtNHgt7EN6HIEQDmxROqpW9pAvYKK_O7cOFTBUSPpOaERSIthqD0YI6oMBVKWV9bkOhvsERwg" type="text/javascript"></script>
...
PanoMapTypeControl.prototype.initialize = function(map) {
  ...
  var earthDiv = me.createButton_("Earth");
  map.addMapType(G_SATELLITE_3D_MAP);
  me.assignButtonEvent_(mapDiv, map, G_NORMAL_MAP, [satDiv, hybDiv, earthDiv]);
  me.assignButtonEvent_(satDiv, map, G_SATELLITE_MAP, [mapDiv, hybDiv, earthDiv]);
  me.assignButtonEvent_(hybDiv, map, G_HYBRID_MAP, [satDiv, mapDiv, earthDiv]);
  me.assignButtonEvent_(earthDiv, map, G_SATELLITE_3D_MAP, [mapDiv, hybDiv, satDiv]);
